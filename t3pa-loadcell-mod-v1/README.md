...
I've changed conical rubber shock absorber with M6x2.1x27x35 compression spring seat because why not? It can be mounted using M6 bolt. It has right amount of compression force than the rubber shock absorber. I've removed the cap to reduce the height.
